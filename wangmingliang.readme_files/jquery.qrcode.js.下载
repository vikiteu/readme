				...
				b = a.extend({}, {
					...
					for(a.addData(utf16to8(b.text)), a.make(),
						...
						for(i = 0; i < a.getModuleCount(); i++) {
							//  二维码前景色渐变
							// var grd = d.createLinearGradient(0, 0, c.width, c.width);
							// grd.addColorStop(0,"#22829e");
							// grd.addColorStop(0.3,"#3cc689");
							// grd.addColorStop(0.7,"#3cc689");
							// grd.addColorStop(1,"#22829e");
							// d.fillStyle = a.isDark(h, i) ? ((b.gradients) ? grd : b.foreground) : b.background,
